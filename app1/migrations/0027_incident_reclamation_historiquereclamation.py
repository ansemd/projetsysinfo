...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app1', '0026_remove_expedition_facture_facture_expeditions_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation_client', models.IntegerField(blank=True, choices=[(1, '1 étoile'), (2, '2 étoiles'), (3, '3 étoiles'), (4, '4 étoiles'), (5, '5 étoiles')], help_text='Note de 1 à 5', null=True)),
